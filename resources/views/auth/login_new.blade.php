...
<html lang="en">
	...
	<body id="kt_body" class="app-blank">
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"  method="POST" action="{{ route('login') }}">
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="text" placeholder="Email" type="email" name="email" :value="old('email')" required autofocus id="email" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Email-->
								</div>
								<!--end::Input group=-->
								<div class="fv-row mb-3">
                                 ...
                                 required autocomplete="current-password" name="password" autocomplete="off" class="form-control bg-transparent" />
									<!--end::Password-->
								</div>
								<!--end::Input group=-->
								<!--begin::Wrapper-->
		...
		<script src="assets/js/custom/authentication/sign-in/general.js1"></script>
