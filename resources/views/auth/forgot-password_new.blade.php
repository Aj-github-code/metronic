	...
	<body id="kt_body" class="app-blank">
        ...
        <x-auth-validation-errors class="mb-4" :errors="$errors" />
								...
								<div class="fv-row mb-8">
									<!--begin::Email-->
									<input type="text" placeholder="Email" id="email"  name="email" :value="old('email')" required autofocus  autocomplete="off" class="form-control bg-transparent" />
									<!--end::Email-->
								</div>
								<!--begin::Actions-->
		...
		<script src="assets/js/custom/authentication/reset-password/reset-password.js1"></script>
